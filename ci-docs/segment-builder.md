---
title: Tạo phân khúc
description: Tạo phân khúc khách hàng để nhóm họ dựa trên các thuộc tính khác nhau bằng cách sử dụng trình tạo phân khúc hoặc phân khúc nhanh.
ms.date: 03/25/2022
