...
- Một [Tài khoản quảng cáo của Microsoft](https://ads.microsoft.com/) và thông tin đăng nhập quản trị viên tương ứng.
- ID khách hàng và ID tài khoản quảng cáo của Microsoft. Tìm ID khách hàng (`cid`) và ID tài khoản (`aid`) trong các tham số của URL khi bạn đăng nhập vào Microsoft Advertising.
- Điều khoản sử dụng Đối sánh khách hàng được chấp nhận.
- [Các phân đoạn đã định cấu hình](segments.md) trong Thông tin chi tiết về khách hàng.
- Hồ sơ khách hàng hợp nhất trong các phân khúc đã xuất chứa các trường đại diện cho địa chỉ email.

## <a name="known-limitations"></a>Các hạn chế đã biết

- Lên đến 500.000 hồ sơ khách hàng cho mỗi lần xuất sang Microsoft Advertising, quá trình này có thể mất đến 10 phút.
- Chỉ phân đoạn.

## <a name="set-up-connection-to-microsoft-advertising"></a>Thiết lập kết nối với Microsoft Advertising

[!INCLUDE [export-connection-include](includes/export-connection-admn.md)]

1. Đi đến **Quản trị viên** > **Kết nối**.

1. Lựa chọn **Thêm kết nối** và lựa chọn **Quảng cáo của Microsoft**.
...
1. Nhập **ID khách hàng quảng cáo của Microsoft**.
...
1. Trong trường **Kết nối để xuất**, hãy chọn một kết nối từ phần Microsoft Advertising. Liên hệ với quản trị viên nếu không có kết nối.
...
1. Nhập **ID tài khoản và ID khách hàng Microsoft Advertising**.
