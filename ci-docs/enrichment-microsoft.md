...
Đi đến **Dữ liệu** > **Làm giàu** đến [định cấu hình và xem các phần bổ sung](enrichment-hub.md).
...
Chúng tôi sử dụng dữ liệu tìm kiếm trực tuyến của Microsoft để tìm sở thích và SoV cho các thương hiệu và sở thích trên các phân khúc nhân khẩu học khác nhau (được xác định theo độ tuổi, giới tính hoặc vị trí). Khối lượng tìm kiếm trực tuyến cho một thương hiệu hoặc sở thích tạo cơ sở để xác định mối quan hệ hoặc SoV. Tuy nhiên, mỗi cách cung cấp một góc nhìn khác nhau để hiểu khách hàng của bạn.
