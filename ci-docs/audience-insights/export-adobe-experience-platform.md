...
Với đối tượng mục tiêu đã được xác định, chúng tôi có thể định cấu hình xuất từ thông tin chuyên sâu về đối tượng sang tài khoản Lưu trữ Azure Blob.
