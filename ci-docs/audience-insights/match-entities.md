...
Sau khi chỉ định thứ tự đối sánh, các cặp đối sánh đã xác định hiển thị trong **Chi tiết hồ sơ phù hợp** phần trên **Dữ liệu** > **Thống nhất** > **Trùng khớp**. Các chỉ số chính trống cho đến khi quá trình đối sánh hoàn tất.
...
1. Bên trong **Phong tục** ngăn, chuyển đến **Hồ sơ** chuyển hướng.
