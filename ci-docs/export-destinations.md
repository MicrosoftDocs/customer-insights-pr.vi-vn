...
- **Phân đoạn xuất khẩu** cho phép bạn xuất các thực thể phân đoạn từ Thông tin chi tiết về khách hàng. Các phân khúc đại diện cho một danh sách các hồ sơ khách hàng. Khi đặt cấu hình xuất, bạn chọn các trường dữ liệu được bao gồm, tùy thuộc vào hệ thống đích mà bạn đang xuất dữ liệu. 
