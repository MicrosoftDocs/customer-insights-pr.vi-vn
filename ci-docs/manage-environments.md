...
2. Quản lý Danh sách kiểm soát truy cập (ACL) trên vùng chứa CustomerInsights trong tài khoản lưu trữ của bạn thông qua các nhóm bảo mật này. Thêm Microsoft Dataverse dịch vụ và bất kỳ Dataverse các ứng dụng kinh doanh dựa trên cơ sở như Dynamics 365 Marketing cho **Người đọc** nhóm an ninh với **chỉ đọc** quyền. Thêm vào *chỉ còn* ứng dụng Thông tin chi tiết về khách hàng cho **Người đóng góp** nhóm bảo mật để cấp cho cả hai **đọc và viết** quyền để viết tiểu sử và thông tin chi tiết.
...
1. Gỡ cài đặt **CustomerInsightsCustomerCard** sự hòa tan.
...
1. Bên trong **Chỉnh sửa môi trường** hộp, đi đến **Thông tin cơ bản** bước chân.
