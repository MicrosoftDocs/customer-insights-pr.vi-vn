...
Xem các thực thể trong [Bộ điều hướng thực thể mô hình dữ liệu chung](https://microsoft.github.io/CDM/). Chọn một thực thể từ phần Ứng dụng Thông tin chi tiết để nhận danh sách các thực thể Customer Insights và định nghĩa của chúng.

:::image type="content" source="media/CDM-entity-navigator.png" alt-text="Bộ điều hướng thực thể CDM hiển thị thực thể CustomerActivity.":::
